...
class CincoBandasPage extends StatefulWidget {
  const CincoBandasPage({super.key});

  @override
  State<CincoBandasPage> createState() => _CincoBandasPageState();
}
...
class _CincoBandasPageState extends State<CincoBandasPage> {
    ...
    return ColoresTolerancias.values.map((ColoresTolerancias color) {
      return DropdownMenuItem<ColoresTolerancias>(
        ...
        child: Row(
          children: [
            Container(
              width: 30, // Ancho del recuadro de color
  ...
  void _calculoValorResistencia() {
    resultado =
        valorBanda1.toString() + valorBanda2.toString() + valorBanda3.toString() + _ceros(valorBanda4);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Resistencia cinco bandas"),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const Text(
                  "Leyendo las bandas de colores, de izquierda a derecha, las 4 primeras bandas nos determinarán su valor, la quinta banda nos indica su tolerancia"),
              const SizedBox(
                height: 40.0,
              ),
              Container(
